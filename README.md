...
> Publication: https://www.frontiersin.org/journals/quantum-science-and-technology/articles/10.3389/frqst.2026.1754112/
...
> Function to generate all 2^(n−1)−1 unique partitions among n elements.
---
* mynchoosek.m
...
---
* exsupsizes.m
> Function to generate numbers k factorable as products k = l * m with the property that ceil(log2(k)) < ceil(log2(l))+ceil(log2(m)) for all l, m. These numbers cannot represent the support sizes of bipartite separable quantum registers containing ceil(log2(k)) qubits.
---
* nqubes.m
